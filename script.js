...
setInterval(() => {
setTimeout(() => {
Array.from(document.querySelectorAll("*")).forEach(el => {$(el).css({"border-radius": "10px", "-webkit-border-radius": "10px", "-moz-border-radius": "10px" });$(el).css({"outline":"none",    "border-style": "none!important"})})
}, 3000);
